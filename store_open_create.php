...
if (
    ...
    !isset($_POST["open_hour"]) || $_POST["open_hour"] == "" ||
...
$sql = "INSERT INTO store_reserve_table (id, username, store_name, open_day, open_hour, secret_item, item_url, item_detail, is_admin, is_deleted, created_at, updated_at) VALUES (NULL, :username, :store_name, :open_day, :open_hour, :secret_item, :item_url, :item_detail, :is_admin, :is_deleted, now(), now())";
...
$stmt->bindValue(':open_hour', $open_hour, PDO::PARAM_STR);
