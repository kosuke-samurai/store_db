...
$sql = "INSERT INTO store_db (id, name, picture, pictype, picsize, category, moodselect, moodtext, foodtext, message, scene, budget, openday, postadress, adress, tell, created_at, updated_at) VALUES (NULL, :name, :picture, :pictype, :picsize, :category, :moodselect, :moodtext, :foodtext, :message, :scene, :budget, :openday, :postadress, :adress, :tell,  now(), now())";
