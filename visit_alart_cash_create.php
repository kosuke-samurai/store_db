...
$session = \Stripe\Checkout\Session::create([
    ...
    'mode' => 'payment',
    'line_items' => [
        ['price' => 'price_1LZ7ypAYLwjaAQ1eI1bHFcuI', 'quantity' => 1],
    ],

    'success_url' => "http://localhost/gs/gs_tamaribar/visit_input.php?id={$id}&date={$date}",
